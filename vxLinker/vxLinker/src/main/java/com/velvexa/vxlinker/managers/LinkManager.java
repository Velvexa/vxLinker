...
import com.velvexa.vxlinker.utils.CodeUtil;
            ...
            public void run() {
                ...
                for (UUID id : expired) {
                    ...
                    if (player != null && player.isOnline()) {
                        player.sendMessage("§cHesap eşleşme kodunun süresi doldu. Yeni bir kod almak için §e/hesapesle §c yaz.");
                    }
                }
            }
        }.runTaskTimerAsynchronously(VXLinker.getInstance(), 20L * 30L, 20L * 60L); 
    }
}
